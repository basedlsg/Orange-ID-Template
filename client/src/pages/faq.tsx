...
/**
 * This component automatically shows the FAQ dialog
 * It reuses the same FAQ content from the FAQButton component
 */
export default function FAQ() {
  const [, setLocation] = useLocation();
  const [isOpen, setIsOpen] = useState(true);
  
  // When the dialog is closed, redirect back to home
  const handleClose = () => {
    setIsOpen(false);
    setLocation('/');
  };
  
  // This is the same FAQ content from the faq-dialog.tsx component
  const faqs = [
    {
    ...
    },
    {
      ...
      answer:
        "As long as you integrate the Orange ID, it doesn't matter when it was produced or released.",
    },
    {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-hidden flex flex-col p-0">
        <DialogHeader className="p-6 pb-2 bg-black-500 dark:bg-orange-950/30">
